...
public class DeckCardController {
     ...
     * 
     *             @PostMapping("{brandId}/iceCream") public ResponseEntity<Brand>
     *             addIceCreamToBrand(@PathVariable int brandId, @RequestBody
     *             IceCream iceCream) { Brand updatedBrand =
     *             brandService.addIceCreamToBrand(brandId, iceCream);
     *             ResponseEntity<Brand> resp = new
     *             ResponseEntity<Brand>(updatedBrand, HttpStatus.CREATED); return
     *             resp; }
