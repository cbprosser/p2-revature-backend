...
CREATE TABLE td_card (
    ...
    card_scryfall_url TEXT NOT NULL,
    card_fallback TEXT NOT NULL
);
```
...
CREATE TABLE td_deck_names (
    deck_name_id SERIAL PRIMARY KEY,
    deck_name TEXT NOT NULL
);

CREATE TABLE td_deck_description (
    deck_description_id SERIAL PRIMARY KEY,
...
CREATE TABLE td_deck (
    ...
    deck_name INTEGER REFERENCES td_deck_names(deck_name_id) NOT NULL,
    deck_format INTEGER REFERENCES td_formats(format_id) NOT NULL,
    deck_description  INTEGER REFERENCES td_deck_description(deck_description_id) NOT NULL,
    deck_privacy BOOLEAN NOT NULL,
    deck_prototype BOOLEAN NOT NULL,
    deck_featured_card INTEGER REFERENCES td_card(card_id) NOT NULL,
    deck_card INTEGER REFERENCES td_card(card_id) UNIQUE NOT NULL,
    deck_card_amount INTEGER NOT NULL,
    deck_creation_date TIMESTAMP WITHOUT TIME ZONE NOT NULL,
    deck_last_updated TIMESTAMP WITHOUT TIME ZONE NOT NULL
);
```
### Collection
...
CREATE TABLE td_collection (
    ...
    collection_privacy BOOLEAN NOT NULL,
    collection_card INTEGER REFERENCES td_card(card_id) UNIQUE NOT NULL,
    collection_card_amount INTEGER NOT NULL,
    collection_creation_date TIMESTAMP WITHOUT TIME ZONE NOT NULL,
    collection_last_updated TIMESTAMP WITHOUT TIME ZONE NOT NULL
);
```
